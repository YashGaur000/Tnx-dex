export const routerAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'stable', type: 'bool', internalType: 'bool' },
      { name: '_factory', type: 'address', internalType: 'address' },
      { name: 'amountInA', type: 'uint256', internalType: 'uint256' },
      { name: 'amountInB', type: 'uint256', internalType: 'uint256' },
      {
        name: 'routesA',
        type: 'tuple[]',
        internalType: 'struct IRouter.Route[]',
  ...
  { type: 'error', name: 'InsufficientAmountA', inputs: [] },
  { type: 'error', name: 'InsufficientAmountADesired', inputs: [] },
  { type: 'error', name: 'InsufficientAmountAOptimal', inputs: [] },
  { type: 'error', name: 'InsufficientAmountB', inputs: [] },
  { type: 'error', name: 'InsufficientAmountBDesired', inputs: [] },
  { type: 'error', name: 'InsufficientLiquidity', inputs: [] },
  { type: 'error', name: 'InsufficientOutputAmount', inputs: [] },
  { type: 'error', name: 'InvalidAmountInForETHDeposit', inputs: [] },
  { type: 'error', name: 'InvalidPath', inputs: [] },
  { type: 'error', name: 'InvalidRouteA', inputs: [] },
  { type: 'error', name: 'InvalidRouteB', inputs: [] },
  { type: 'error', name: 'InvalidTokenInForETHDeposit', inputs: [] },
  { type: 'error', name: 'OnlyWETH', inputs: [] },
  { type: 'error', name: 'PoolDoesNotExist', inputs: [] },
  { type: 'error', name: 'PoolFactoryDoesNotExist', inputs: [] },
  { type: 'error', name: 'SameAddresses', inputs: [] },
