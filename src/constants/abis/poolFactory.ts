export const poolFactoryAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: '_stable', type: 'bool', internalType: 'bool' },
    ],
    outputs: [{ name: '', type: 'uint256', internalType: 'uint256' }],
    stateMutability: 'view',
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'stable', type: 'bool', indexed: true, internalType: 'bool' },
      {
        name: 'pool',
        type: 'address',
        indexed: false,
  ...
  },
  {
    ...
    name: 'SetPauseState',
    inputs: [
      { name: 'state', type: 'bool', indexed: false, internalType: 'bool' },
    ],
    anonymous: false,
  },
  {
  ...
  { type: 'error', name: 'FeeInvalid', inputs: [] },
  { type: 'error', name: 'FeeTooHigh', inputs: [] },
  { type: 'error', name: 'InvalidPool', inputs: [] },
  { type: 'error', name: 'NotFeeManager', inputs: [] },
  ...
  { type: 'error', name: 'ZeroFee', inputs: [] },
];
